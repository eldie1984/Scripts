...
URL_INTRA=http://intranet.clasificados.int.clarin.com:81/intramoar  # URL usada para generar los XMLs de la 4º columna
FILER_MO=
...
MAIL_ERROR_TO="soporte@cmd.com.ar,Gaston.Saladino@neuralsoft.com, Julian.GraciaSalgueiro@neuralsoft.com,sgoldentair@claringlobal.com.ar,fraffetto@claringlobal.com.ar"
...
CLASSPATH=${CLASSPATH}:${LIBS_PATH}/commons-httpclient-3.1.jar
CLASSPATH=${CLASSPATH}:${LIBS_PATH}/commons-codec-1.2.jar
