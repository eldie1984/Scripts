...
variables(){
	APP_NAME=archivar_avisos     # Nombre del Aplicativo. Todos los archivos de log y out llevaran este nombre.(PARAMETRO)
	APP_FUNCION="Depuración de avisos-Baja Física." # (PARAMETRO)
...
EjecutarSQL archivar_avisos.sql
