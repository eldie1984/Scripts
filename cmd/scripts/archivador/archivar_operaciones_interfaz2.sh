...
variables(){
	APP_NAME=archivar_mails     # Nombre del Aplicativo. Todos los archivos de log y out llevaran este nombre.(PARAMETRO)
	APP_FUNCION="Depuración de mails-Baja Física." # (PARAMETRO)
...
EjecutarSQL archivar_operaciones_interfaz2.sql
