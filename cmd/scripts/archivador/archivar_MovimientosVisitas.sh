...
variables(){
	APP_NAME=archivar_busquedas     # Nombre del Aplicativo. Todos los archivos de log y out llevaran este nombre.(PARAMETRO)
	APP_FUNCION="Depuración de busquedas-Baja Física." # (PARAMETRO)
...
EjecutarSQL archivar_MovimientosVisitas.sql
