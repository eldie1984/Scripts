...
variables(){
	APP_NAME=archivar_log_envio_mails     # Nombre del Aplicativo. Todos los archivos de log y out llevaran este nombre.(PARAMETRO)
	APP_FUNCION="Depuración de logs de envios de mails-Baja Física." # (PARAMETRO)
...
EjecutarSQL archivar_log_envio_mails.sql
