...
<title>Chequeo Batch Sysame</title>
...
$consulta = "select id,host,app from userbk where host in ('yvasa850','yvasa880')";
...
<?php while(($row = oci_fetch_object ($stid)) != false) { 
 #echo "<center><h1>".$row->HOST." " .$row->APP."</h1> </center>" ;
 echo "<h1>".$row->HOST." " .$row->APP."</h1>" ;
 echo "
 <div id=\"content\">
		<table width=\"612\" border=\"0\">
              <tr bgcolor=\"#FFFF99\">
